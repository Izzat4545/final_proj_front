...
const props = defineProps<{ gifts?: PopularGifts }>();
...
const link = ref(props.gifts ? props.gifts?.currency : "")
...
const handleEvent = async () => {
    try {
        if (props.gifts) {
            ...
            // resettings the form
            (name.value = ""), (price.value = ""), (image.value = null), (link.value = ""), (description.value = "");
        }
    } catch (err) {
        ...
        <div class="p-4">
            ...
            <form @submit.prevent="handleEvent" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" v-model="name" class="input input-bordered w-full" placeholder="Enter gift name"
                        required />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" placeholder="Enter gift price" v-model="price"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" v-model="link" class="input input-bordered w-full" placeholder="Enter shop link"
                        required />
                </div>
