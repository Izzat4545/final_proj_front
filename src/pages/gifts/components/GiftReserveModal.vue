        ...
        <div class="p-4">
            ...
            <form @submit.prevent="handleReservation" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" v-model="email" class="input input-bordered w-full" placeholder="Enter email"
                        required />
                </div>
                <!-- Submit Button -->
                <button type="submit" class="btn btn-success text-white w-full flex justify-center items-center gap-2"
                    :disabled="loading">
