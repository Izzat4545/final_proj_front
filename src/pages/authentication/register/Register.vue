...
const googleSignIn = () => {
    const googleAuthUrl = `${getEnv("VITE_BASE_URL")}/auth/google`;
    ...
    <div class="min-h-screen flex justify-center items-center bg-gray-100">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form @submit.prevent="register">
                ...
                <button :disabled="authStore.loading" :class="authStore.loading ? 'bg-gray-500' : 'bg-blue-500 hover:bg-blue-600'" type="submit"
            ...
            <div class="mt-4">
                <button @click="googleSignIn" class="w-full bg-red-500 text-white py-2 rounded hover:bg-red-600">
                    Sign in with Google
                </button>
            </div>
        </div>
