    ...
    <div class="container mx-auto flex justify-between items-center p-4">
      <div class="flex items-center">
        <router-link to="/" class="flex items-center">
          <span class="text-xl font-bold">Gift<span class="text-red-500">Me</span></span>
        </router-link>
      </div>
      <nav class="flex items-center space-x-4">
        ...
        <template v-else>
          ...
          <router-link to="/events" class="text-gray-700 hover:text-blue-500">Events</router-link>
          <router-link to="/settings" class="text-gray-700 hover:text-blue-500">Settings</router-link>
