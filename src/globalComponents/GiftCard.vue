...
<template>
  <div
    class="flex my-3 justify-center sm:justify-start items-center gap-5 flex-wrap"
  >
    <div
      v-for="gift in gifts.gifts"
      class="bg-white rounded-lg relative shadow-md p-4 flex flex-col items-start"
    >
      <img
